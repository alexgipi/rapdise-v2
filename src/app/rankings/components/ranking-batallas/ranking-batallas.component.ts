...
@Component({
  selector: 'ranking-batallas',
  templateUrl: './ranking-batallas.component.html',
  providers: [UserService, FollowService]
})

export class RankingBatallasComponent implements OnInit {
	...
	constructor(
		...
		this.titulo = 'Ranking de batallas';
