...
@Component({
  selector: 'ranking-freestyle',
  templateUrl: './ranking-freestyle.component.html',
  providers: [UserService, FollowService]
})

export class RankingFreestyleComponent implements OnInit {
	...
	constructor(
		...
		this.titulo = 'Ranking de freestyle';
