...
@Component({
  selector: 'reproductor-biblioteca-con-listado',
  templateUrl: './reproductor-biblioteca-con-listado.component.html',
  providers: [UserService, BeatService, LikeBeatService, FavoritoService]
})

export class ReproductorBibliotecaConListadoComponent implements OnInit, OnChanges {
    // Decorador Output
